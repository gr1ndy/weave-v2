...
void I::Setup()
{
	...
	[]() {
		...
		g_HookIndices[fnva1(hs::Hooked_CreateMove.s().c_str())] = 22;
...
void H::Hook()
{
	...
	g_pClientHook->Hook(g_HookIndices[fnva1(hs::Hooked_CreateMove.s().c_str())], Hooked_CreateMove_Naked);
...
void H::UnHook()
{
	...
	g_pClientHook->Unhook(g_HookIndices[fnva1(hs::Hooked_CreateMove.s().c_str())]);
