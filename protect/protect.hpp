...
namespace hs {
	...
	/* misc */
	_(weave_su, "weave.su fixed by shonax");
	_(weave_logo, "WEAVE.SU fixed by shonax");
	...
	_(modify_eye_pos, "55 8B EC 83 E4 F8 83 EC 70 56 57 8B F9 89 7C 24 14 83 7F 60"); // 85 C0 0F 84 ? ? ? ? 8B 45 08 8B 0D
	...
	_(physicssimulate, "56 8B F1 8B 8E ? ? ? ? 83 F9 FF 74 23"); // 56 8B F1 8B 8E ? ? ? ? 83 F9 FF 74 21
